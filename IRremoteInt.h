...
extern volatile irparams_t irparams[NRECV];
...
#define TIMER_DISABLE_INTR2   (TIMSK1 = 0)
...
//WGM=1010, CS=001, val=56, SYSCLOCK=16mhz, pwmval=143
//f=SYSCLOCK/(2*ICR1)
/*
...
#define TIMER_ENABLE_INTR    (TIMSK2 = _BV(OCIE2A))
#define TIMER_DISABLE_INTR   (TIMSK2 = 0)
#define TIMER_DISABLE_INTR2   (TIMSK0 = 0)
#define TIMER_INTR_NAME      TIMER2_COMPA_vect
#define TIMER_CONFIG_KHZ(val) ({ \
...
//WGM=101, CS =001, OCR0A = 143, OCR0B = 48, f=56kHz, D=1/3
 */
